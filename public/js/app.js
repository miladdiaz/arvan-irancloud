...
window.initIrancloud = function () {
  var questionItems = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_0__["$"])('.questions__item');
  var activeItemClass = 'questions__item--active';
  questionItems.forEach(function (questionItem) {
    questionItem.addEventListener('click', function () {
      ...
      ;
      questionItems.forEach(function (questionItemRemover) {
  ...
  var irancloudTabItems = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_0__["$"])('.whatis__tab-list');
  var irancloudTabItemActiveClass = "whatis__tab-list--active";
  var irancloudTabBodys = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_0__["$"])('.whatis__tab-body');
  var tabBodyActiveClass = "whatis__tab-body--active";
  irancloudTabItems.forEach(function (irancloudTabItem) {
    irancloudTabItem.addEventListener('click', function (event) {
      irancloudTabItems.forEach(function (irancloudTabItemRemover) {
      ...
      irancloudTabBodys.forEach(function (irancloudTabBodysRemover) {
      ...
      var targetBodyId = event.target.getAttribute('data-bodyid');
      Object(_utils_dom__WEBPACK_IMPORTED_MODULE_0__["$"])('#' + targetBodyId).classList.add(tabBodyActiveClass);
      irancloudTabItem.classList.add(irancloudTabItemActiveClass);
    });
  });
  var irancloudDatacenter = [['اسیاتک', 'تهران', 'میلاد', '۴۰۸'], ['پارس‌آنلاین', 'تهران', 'پردیس', '۳۰۰'], ['افرانت', 'تهران', '-', '۲۵۰'], ['تبیان', 'تهران', '-', '۷۲'], ['ایرانسل', 'تهران', 'مرکز داده غرب', '۴۰۷'], ['همراه‌اول', 'تهران', 'مرکز کاظمیان', '۵۴'], ['همراه‌اول', 'تبریز', '-', '۲۵۰']];
  irancloudDatacenter.forEach(function (items) {
    var irancloudItems = document.createElement('div');
    irancloudItems.classList.add('whatis__tab-project-tech-table-body-items');
    items.forEach(function (item) {
      var irancloudItem = document.createElement('div');
