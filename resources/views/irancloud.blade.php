        ...
        <main class="irancloud">
            <section class="whatis">
                <div class="container">
                    ...
                    ابر ایران قراردادی میان سازمان فناوری اطلاعات ایران  و دو کنسرسیوم با نام‌های اپراتور  ابر شمالی (آسیاتک، ژرف‌نگر، ابرزس) و اپراتور ابر جنوبی (فناپ و ابرآروان) است که در زمستان سال ۱۳۹۹ و به‌منظور توسعه، تجهیز و راه‌اندازی سرویس ابری روی ۱۰ دیتاسنتر موجود در کشور منعقد شد.
به‌دلیل تجمیع بیش‌تر دیتاسنترهای ایران در پایتخت، دسترسی‌پذیری  کسب‌وکارهایی که در شهرستان‌ها فعال هستند به زیرساخت ابری با سختی همراه است. هم‌چنین دسترسی مردم در نقاط دور از مرکز به بسیاری از سرویس‌ها با کیفیت پایین انجام می‌شود. از این رو سازمان فناوری اطلاعات تصمیم گرفت طی مزایده‌ای، پروژه‌ی ابر ایران که ایده آن در سال ۹۶ شکل گرفته بود را به‌منظور تسریع توزیع محتوا میان مناطق مختلف ایران، افزایش ابرزی کردن کسب‌وکارهای محلی و هم‌چنین تقویت دولت الکترونیک به بخش خصوصی واگذار کند.
در پروژه ابر ایران دیتاسنترهایی که در شهرهای تبریز، مشهد، قم، همدان و اصفهان قرار داشت، ابر شمالی نام گرفت و دیتاسنترهایی که در شهرهای شیراز، اصفهان، اهواز،‌ کرج و تبریز مستقر بود، ابر جنوبی نامیده شد.                    <br>
                    <br>
                    ...
                    <div class="whatis__tab">
                        ...
                        <div class="whatis__tab-bodys">
                            <div class="whatis__tab-body" id="whatis-tab-project-target">
                                ...
                                <br>
                                علاوه‌بر این راه‌اندازی پروژه ابر ایران بهبود کیفیت و افزایش سرعت توزیع محتوا و کاهش هزینه‌های استفاده از زیرساخت ابری را برای کسب‌وکارها به ارمغان می‌آورد.
                                <br>
                                <br>
                            ...
                            <div class="whatis__tab-body" id="whatis-tab-project-history">
                                ...
                                <div class="whatis__tab-body-subtitle">
                                از سال ۱۳۹۶ رییس سابق سازمان فناوری اطلاعات تلاش‌هایی را برای واگذاری دیتاسنترهای نیمه‌فعال و ورشکسته‌ی استانی دولت آغاز کرد که زمان‌بر بودن این فرآیند، کمبود شرکت‌های واجد شرایط و نبود سازوکارهای مربوطه این کار را با کندی مواجه کرده بود. پس از تغییر ریاست سازمان فناوری اطلاعات و پی‌گیری‌های سازمان فناوری اطلاعات ایران، این پروژه نام‌ تازه‌ای به خود گرفت و «ابر ایران» نامیده شد. طی یک <a href="https://ito.gov.ir/page/bid/609d45a2-e21a-4dd4-aba7-241714533881">فراخوان عمومی</a> در ۳۰ مهر ۱۳۹۸ از طرف سازمان فناوری اطلاعات مزایده پروژه ابر ایران کلید خورد و پس از آن اسناد مزایده در دی ماه ۹۸ منتشر شد. پس از تجمیع دیتاسنتر‌های قابل واگذاری در دو منطقه‌ی شمالی و جنوبی، مزایده‌هایی برای واگذاری به بخش خصوصی برگزار شد که بیش از ۲۰ شرکت در آن حضور داشتند.                                     <br>
                            ...
                            <div class="whatis__tab-body whatis__tab-body--active" id="whatis-tab-project-tech">
                                ...
                                <div class="whatis__tab-project-tech-map-subtitle">
                                    با توجه به اطلاعات ذکر شده <a href="https://www.itmen.ir/news/275367/%25D9%25BE%25D8%25B1%25D9%2588%25DA%2598%25D9%2587-2400-%25D9%2585%25DB%258C%25D9%2584%25DB%258C%25D8%25A7%25D8%25B1%25D8%25AF-%25D8%25AA%25D9%2588%25D9%2585%25D8%25A7%25D9%2586%25DB%258C-%25D8%25A7%25D8%25A8%25D8%25B1-%25D8%25A7%25DB%258C%25D8%25B1%25D8%25A7%25D9%2586-%25D9%2588%25D8%25A7%25D8%25B1%25D8%25AF-%25D9%2581%25D8%25A7%25D8%25B2-%25D8%25A7%25D8%25AC%25D8%25B1%25D8%25A7%25DB%258C%25DB%258C"> کل تجهیزات واگذار شده </a> در قرارداد ابر ایران به کنسرسیوم ابری «ابر آروان-فناپ»، شامل ۲۱۶ سرور، ۱۳ پتابایت فضای ذخیره‌سازی و ۱۰۴ رک خواهد بود که این میزان با رسیدن به ظرفیت کامل، کم‌تر از ۳ تا ۵درصد از ظرفیت دیتاسنترهای عمومی کل کشور به شمار می‌آید.
                                    <br>
                                    <br>
                                    در نقشه‌ی زیر می‌توانید تعداد رک‌های منطقه‌ی دوم پروژه‌ی ابر ایران، کنسرسیوم «ابر آروان-فناپ» را به تفکیک هر شهر مشاهده کنید:                                </div>
                                <div class="whatis__tab-project-tech-latency">
                                    ...
                                    <div class="whatis__tab-project-tech-latency-footer">این رک‌ها به شکل Co-Location یا هم‌مکان در سالن شرکت ارتباطات زیرساخت است و هزینه‌ی اجاره‌ی آن جداگانه پرداخت می‌شود.</div>
                                </div>
                                <div class="whatis__tab-project-tech-map">
                                    @svg('svg/irancloud/map.svg')
                                    <div class="whatis__tab-project-tech-map-markers">
                                        <div class="whatis__tab-project-tech-map-marker whatis__tab-project-tech-map-marker--isfahan" id="map-isfahan-point-marker">
                                            <div class="whatis__tab-project-tech-map-marker-col">
                                                <div class="whatis__tab-project-tech-map-marker-right">تعداد رک</div>
                                                <div class="whatis__tab-project-tech-map-marker-left">۱۶</div>
                                            </div>
                                            <div class="whatis__tab-project-tech-map-marker-spacer"></div>
                                            <div class="whatis__tab-project-tech-map-marker-col">
                                                <div class="whatis__tab-project-tech-map-marker-right">Latency از تهران</div>
                                                <div class="whatis__tab-project-tech-map-marker-left">۶.۵</div>
                                            </div>
                                        </div>

                                        <div class="whatis__tab-project-tech-map-marker whatis__tab-project-tech-map-marker--ahvaz" id="map-ahvaz-point-marker">
                                            <div class="whatis__tab-project-tech-map-marker-col">
                                                <div class="whatis__tab-project-tech-map-marker-right">تعداد رک</div>
                                                <div class="whatis__tab-project-tech-map-marker-left">۱۶</div>
                                            </div>
                                            ...
                                            <div class="whatis__tab-project-tech-map-marker-col">
                                                <div class="whatis__tab-project-tech-map-marker-right">Latency از تهران</div>
                                                <div class="whatis__tab-project-tech-map-marker-left">۱۸.۳</div>
                                            </div>
                                        </div>

                                        <div class="whatis__tab-project-tech-map-marker whatis__tab-project-tech-map-marker--shiraz" id="map-shiraz-point-marker">
                                            <div class="whatis__tab-project-tech-map-marker-col">
                                                <div class="whatis__tab-project-tech-map-marker-right">تعداد رک</div>
                                                <div class="whatis__tab-project-tech-map-marker-left">۱۶</div>
                                            </div>
                                            ...
                                            <div class="whatis__tab-project-tech-map-marker-col">
                                                <div class="whatis__tab-project-tech-map-marker-right">Latency از تهران</div>
                                                <div class="whatis__tab-project-tech-map-marker-left">۱۴.۶</div>
                                            </div>
                                        </div>

                                        <div class="whatis__tab-project-tech-map-marker whatis__tab-project-tech-map-marker--tehran" id="map-tehran-point-marker">
                                            <div class="whatis__tab-project-tech-map-marker-col">
                                                <div class="whatis__tab-project-tech-map-marker-right">تعداد رک</div>
                                                <div class="whatis__tab-project-tech-map-marker-left">?</div>
                                            </div>
                                            <div class="whatis__tab-project-tech-map-marker-spacer"></div>
                                            <div class="whatis__tab-project-tech-map-marker-col">
                                                <div class="whatis__tab-project-tech-map-marker-right">Latency از تهران</div>
                                                <div class="whatis__tab-project-tech-map-marker-left">۰</div>
                                            </div>
                                        </div>

                                        <div class="whatis__tab-project-tech-map-marker whatis__tab-project-tech-map-marker--karaj" id="map-karaj-point-marker">
                                            <div class="whatis__tab-project-tech-map-marker-col">
                                                <div class="whatis__tab-project-tech-map-marker-right">تعداد رک</div>
                                                <div class="whatis__tab-project-tech-map-marker-left">۱۶</div>
                                            </div>
                                            ...
                                            <div class="whatis__tab-project-tech-map-marker-col">
                                                <div class="whatis__tab-project-tech-map-marker-right">Latency از تهران</div>
                                                <div class="whatis__tab-project-tech-map-marker-left">۱.۸</div>
                                            </div>
                                        </div>

                                        <div class="whatis__tab-project-tech-map-marker whatis__tab-project-tech-map-marker--tabriz" id="map-tabriz-point-marker">
                                            <div class="whatis__tab-project-tech-map-marker-col">
                                                <div class="whatis__tab-project-tech-map-marker-right">تعداد رک</div>
                                                <div class="whatis__tab-project-tech-map-marker-left">۴۰</div>
                                            </div>
                                            <div class="whatis__tab-project-tech-map-marker-spacer"></div>
                                            <div class="whatis__tab-project-tech-map-marker-col">
                                                <div class="whatis__tab-project-tech-map-marker-right">Latency از تهران</div>
                                                <div class="whatis__tab-project-tech-map-marker-left">۸.۹</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="whatis__tab-project-tech-map-footer">
                                        <div class="whatis__tab-project-tech-map-footer-inner">این رک‌ها به شکل Co-Location یا هم‌مکان در سالن شرکت ارتباطات زیرساخت است و هزینه‌ی اجاره‌ی آن جداگانه پرداخت می‌شود.</div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="project">
                <div class="container">
                    ...
                    پروژه‌ی ابر ایران هیچ ارتباطی با ایجاد پدیده‌ی ناموزون و نامیمون اینترنت ملی ندارد. تمام اینترنت ایران به‌شکل انحصاری به‌وسیله‌ی شرکت ارتباطات زیرساخت و در لایه‌ی بعدی اپراتورهای موبایل و FCP تهیه می‌شود و هیچ یک از زیرساخت‌های ابری ایران، مسیری برای دسترسی به اینترنت، خارج از این محدوده ندارند. 
اینترنت بین‌الملل از طریق ۹ درگاه مختلف در نقاط مرزی کشور وارد ایران می‌شود و پس از آن به‌وسیله‌ی شرکت ارتباطات زیرساخت بین اپراتورهای موبایل و FCPها یا شرکت‌های ارایه‌ی خدمات ثابت تقسیم می‌شود که آن‌ها اینترنت دریافت‌ شده را به‌شکل تجاری بین مشتریان خود توزیع می‌کنند. دیتاسنترها و شرکت‌های ارایه‌دهنده‌ی خدمات ابری، دریافت‌کننده‌ی خدمات از این شرکت‌ها هستند و در هیچ‌یک از نقاط مسیر تحویل اینترنت به مشتری قرار ندارند.                    <br>
                    
                    <b>ابر ایران پروژه‌ای برای ارتقا، تجهیز و ابری‌سازی تعداد محدودی از دیتاسنترهای موجود در کشور با ظرفیتی معادل ۳ تا ۵درصد ظرفیت کل دیتاسنترهای عمومی ایران است که از نظر فنی، خدمات ابری ارایه‌شده به‌وسیله‌ی این دیتاسنترها که خود از مصرف‌کنندگان خدمات اینترنت به‌شمار می‌آیند، هیچ نقشی در زیرساخت اینترنت کشور ایفا نمی‌کند و تنها به منظور تبدیل زیرساخت‌های سنتی به زیرساخت‌های ابری مورد استفاده قرار می‌گیرد.</b>
                        <br>
                        بر این اساس ابر آروان به عنوان یکی از طرفین قرارداد ابر ایران هیچ اقدام و تلاشی برای مشارکت یا ورود به پروژه‌هایی که هدف آن‌ها قطع دسترسی مردم ایران به اینترنت است نداشته و نخواهد داشت و همواره از طریق اقداماتی مانند راه‌اندازی <a href="https://radar.arvancloud.com/">سامانه‌ی رادار</a> و صفحه‌ی <a href="https://www.arvancloud.com/fa/reports/transparency-report"> گزارش شفافیت </a> از دسترسی بدون محدودیت همه‌ی مردم ایران به اینترنت و حفظ حریم خصوصی کاربران حمایت کرده و می‌کند.
